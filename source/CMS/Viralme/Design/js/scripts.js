...
// google map styles and functions  --------
	...
	var map;
	// your coordinates   --------
	var cashemir = new google.maps.LatLng(32.676784, 51.692869);
	function initialize() {	
	  var styles = [
		{
			featureType: 'water',
	...
	var companyImage = new google.maps.MarkerImage('/Viralme/Design/images/marker.png',
		new google.maps.Size(30,30),
		new google.maps.Point(0,0),
		new google.maps.Point(28,58)
	);
	// your marker coordinates   --------
	var companyPos = new google.maps.LatLng(32.676784, 51.692869);
