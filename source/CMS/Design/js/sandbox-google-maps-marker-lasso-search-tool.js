...
function initialize() {
    ...
    var myOptions = { zoom: 16, center: latlng, mapTypeId: google.maps.MapTypeId.SATELITE, draggableCursor: 'crosshair', mapTypeControlOptions: { style: google.maps.MapTypeControlStyle.DROPDOWN_MENU } };
